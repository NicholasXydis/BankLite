...
namespace BankLite.Application.Interfaces
{
    public interface ITransactionService
    {
        ...
        Task<PagedResultDto<TransactionResponseDto>> GetTransactionsByAccountIdAsync(Guid accountId, Guid userId, int page, int pageSize, string? type = null);
        Task<IEnumerable<TransactionResponseDto>> GetTransactionsByDateRangeAsync(Guid accountId, Guid userId, DateTime startDate, DateTime endDate);
    }
}
