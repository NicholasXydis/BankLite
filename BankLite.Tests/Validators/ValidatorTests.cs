...
namespace BankLite.Tests.Validators
{
    public class ValidatorTests
    {
        ...
        {
            var dto = new TransferDto { FromAccountId = Guid.NewGuid(), ToAccountId = Guid.NewGuid(), Amount = (decimal)amount };
        ...
        {
            var dto = new ExternalTransferDto { FromAccountId = Guid.NewGuid(), ToAccountNumber = "ACC123456789", Amount = (decimal)amount };
        ...
        {
            var dto = new ExternalTransferDto { FromAccountId = Guid.NewGuid(), ToAccountNumber = accountNumber, Amount = 100 };
        ...
        [InlineData(" Test User", "test@banklite.com", "Password123")]
        [InlineData("Test User ", "test@banklite.com", "Password123")]
        public async Task RegisterUserValidator_InvalidFullName_FailsValidation(string fullName, string email, string password)
        {
            var dto = new RegisterUserDto { FullName = fullName, Email = email, Password = password };
