...
namespace BankLite.Tests.Integration
{
    ...
    public class SecurityIntegrationTests : IAsyncLifetime
    {
        ...
        {
            var wrongSecretToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
        ...
        {
            var wrongIssuerToken = GenerateTokenWithWrongClaims(issuer: "WrongIssuer");
        ...
        public async Task InputValidation_OversizedBody_HandledGracefully()
        {
            ...
            var response = await _client.PostAsync("/api/auth/login",
                new StringContent($"{{\"email\":\"{oversizedBody}\",\"password\":\"{oversizedBody}\"}}", Encoding.UTF8, "application/json"));
        ...
        private static string GenerateTokenWithWrongClaims(string issuer = "BankLiteAPI", string audience = "BankLiteClient")
        {
